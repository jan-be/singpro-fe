...
const PrivacyPolicyContent = () => (
  <>
    <div className="text-gray-300 space-y-6">
      ...
      <p className="text-sm text-gray-500">Last updated: 19 September 2026</p>
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc list-inside space-y-1 ml-2">
          ...
          <li><strong className="text-white">Listen history:</strong> We record which songs are played (artist, title, video ID, party code, the display name used, how long the song ran, the round-trip time of your connection during it, the page you arrived from and the country our CDN places your address in) to power the "Popular at Parties" feature and to see how the site is used. This data is not linked to an account.</li>
